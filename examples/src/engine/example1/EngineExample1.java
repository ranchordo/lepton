...
public class EngineExample1 {
	...
	public void Main() {
		...
		EngineExample1Floor floor=new EngineExample1Floor(new Vector3f(0,-10,0),LeptonUtil.AxisAngle_np(new AxisAngle4f(1,0,0,(float)Math.toRadians(-90))));
		EngineExample1Cube cube=new EngineExample1Cube(new Vector3f(0,0,0),LeptonUtil.AxisAngle_np(new AxisAngle4f(1,0,0,0)));
		cube.initSoundtrack();
		cube.initGeo();
		cube.initPhysics();
		floor.initGeo();
