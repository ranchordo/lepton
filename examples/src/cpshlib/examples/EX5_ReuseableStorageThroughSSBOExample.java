...
public class EX5_ReuseableStorageThroughSSBOExample {
	public void Main() {
		...
		ComputeShader ballInitializer=new ComputeShader("example5/ballInitializer");
		ComputeShader ballProcessorRenderer=new ComputeShader("example5/ballRenderer");
		ComputeShader ballPost=new ComputeShader("example5/ballPostProcessor");
	...
	public static void main(String[] args) {
		EX5_ReuseableStorageThroughSSBOExample m=new EX5_ReuseableStorageThroughSSBOExample();
		m.Main();
	}
}
