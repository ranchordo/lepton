...
import com.github.ranchordo.lepton.engine.util.Generic3DObject;
import com.github.ranchordo.lepton.optim.objpoollib.PoolStrainer;
import com.github.ranchordo.lepton.tests.engineTest.EngineTestFloor;
import com.github.ranchordo.lepton.tests.engineTest.EngineTestScreen;
import com.github.ranchordo.lepton.util.CleanupTasks;
import com.github.ranchordo.lepton.util.ImageUtil;
...
import com.github.ranchordo.lepton.util.advancedLogger.LogLevel;
import com.github.ranchordo.lepton.util.advancedLogger.Logger;
import com.github.ranchordo.lepton.util.advancedLogger.defaultHandlers.ConsoleWindowHandler;
import com.github.ranchordo.lepton.util.advancedLogger.defaultHandlers.FileHandler;
...
public class FancyGraphicsTest {
	...
	private static void errorLog() {
		fh=new FileHandler(LeptonUtil.getExternalPath()+"/FancyGraphicsTest");
...
//		Logger.levels[0].keepLocalLog=false; //We don't care about debug
		...
		ConsoleWindow mainConsoleWindow=new ConsoleWindow(false,848,480,"Fancy graphics test console",(s)->recieveCommand(s),"Fancy graphics test console ready.\nStarting engine test.");
		...
		GLContextInitializer.initializeGLContext(true,848,480,false,"Graphics settings: 2147483647%");
...
//		physics.EXPOSE_COLLISION_DATA=false;
