package org.lepton.cpshlib.main;
...
import org.lepton.engine.rendering.TextureCache;
...
public class GLContextInitializer {
	...
	public static void initializeGLContext(boolean showWindow, int w, int h, boolean fullscreen, String windowTitle) {
		...
		if(win==0) {
			org.lepton.util.advancedLogger.Logger.log(4,"win is 0, maybe there was an init error?");
		}
		if(showWindow) {
			glfwShowWindow(win);
		} else {
